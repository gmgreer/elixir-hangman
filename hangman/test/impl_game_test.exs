defmodule HangmanImplGameTest do
  ...
  test "letters are all lower case ASCII characters" do
    game = Game.new_game()
    assert Enum.any?(game.letters, fn x -> String.match?(x, ~r/[a-z]$/) end)
  end
  ...
  test "We recognize a correct letter in the word" do
    game = Game.new_game("wombat")
  ...
  test "We recognize a wrong letter in the word" do
    game = Game.new_game("wombat")
